...
| `+` | `+` |
| [ubuntu-iso-builder-remix-sway](https://samwhelp.github.io/ubuntu-iso-builder-remix-sway/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-sway) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-sway](https://samwhelp.github.io/ubuntu-iso-builder-respin-sway/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-sway) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-sway/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-sway/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-sway/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-sway](https://github.com/samwhelp/ubuntu-iso-builder-remix-sway)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-sway.git
```


> change dir to `ubuntu-iso-builder-remix-sway`

``` sh
cd ubuntu-iso-builder-remix-sway
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-sway/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-sway/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-sway/iso-profile/dist`
